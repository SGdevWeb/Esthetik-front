...
//       try {
//         const response = await axios.get("http://localhost:3001/rates"); // Remplacez "/api/tarifs" par l'endpoint réel de votre API pour récupérer les tarifs
...
//               <NavLink
//                 className={styles.navlink}
//                 to={`/prestations/${tarif.typeService.split(" ").join("_")}`}
//               >
//                 {tarif.typeService}
//               </NavLink>
//               {/* <div className={styles.dropdown}>
